...
#choose this to copy your existing files to new directory
option 1: $ sudo cp -rf /var/www/html/* /var/www/gcs-fuse/wordpress/
option 2: $ sudo gsutil cp -r /var/www/html/* gs://bicaraitcom-fuse-wordpress-storage/wordpress
